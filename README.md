...
```
git clone https://github.com/aopatricio/portugal-chatbotv2
```
...
[![Deploy to IBM Cloud](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=https://github.com/aopatricio/portugal-chatbotv2.git)
...
Once deployed, the app can be viewed by clicking `View app`. The app can also be viewed in the dashboard. The app should be prefixed with the string `portugal-chatbotv2`, and the corresponding services that were created can easily be identified by the `wvb-` prefix, i.e.: `wvb-assistant`.
...
Clone the `portugal-chatbotv2` repo locally. In a terminal, run:
